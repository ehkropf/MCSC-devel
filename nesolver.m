%NESOLVER   MCSC nonlinear solver abstract class.
%   This handle class does nothing more than provide ancestry and handle
%   class properties. Subclasses must define a run_solver(S) method.
%
%   See also mcscmap.
%
%
