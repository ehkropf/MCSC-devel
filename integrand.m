%INTEGRAND   MCSC integrand superclass.
%   This class must be subclassed and is only here to provide parentage and
%   handle class properties for bounded and unbounded inegrands.
%
%
